...
function SummaryCard({day}) {
    ...
    return (
        <li className="container p-1 pb-0 flex items-center justify-center bg-gray-200 rounded-lg my-auto mr-1 ">
            <div className="my-auto">
                <p className="font-bold text-2xl text-pink-600 mb-1">{Math.round(day.main.temp)}&deg;C</p>
                <p className="text-1 text-gray-800 tracking-widest">{day.weather[0].main}
